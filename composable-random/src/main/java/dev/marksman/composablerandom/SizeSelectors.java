...
public class SizeSelectors {
    ...
    public static class MinMaxPreferred implements SizeSelector {
        ...
        @Override
        public Result<? extends RandomState, Integer> selectSize(RandomState input) {
            Result<RandomState, Boolean> s1 = shouldUsePreferred(input);
            if (s1.getValue()) {
    ...
    private static Result<RandomState, Boolean> shouldUsePreferred(RandomState input) {
        Result<? extends RandomState, Integer> s1 = input.nextIntBounded(7);
