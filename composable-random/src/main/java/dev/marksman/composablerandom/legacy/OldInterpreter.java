...
public class OldInterpreter {
    ...
    private OldInterpreter(Context context) {
    ...
    public static OldInterpreter defaultInterpreter() {
        return new OldInterpreter(defaultContext());
    }

    public static OldInterpreter defaultInterpreter(Context context) {
        return new OldInterpreter(context);
    }
