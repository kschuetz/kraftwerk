...
public class Generators {
    ...
    @SafeVarargs
    public static <A> OldGenerator<A> frequency(FrequencyEntry<? extends A> first, FrequencyEntry<? extends A>... more) {
        return Choose.frequency(first, more);
    }

    public static <A> OldGenerator<A> frequency(Collection<FrequencyEntry<? extends A>> entries) {
