...
public interface Interpreter {
    ...
    default <A> Interpreter andThen(BiFunction<InterpreterContext, Generator<A>, CompiledGenerator<A>> other) {
        return andThen(interpreter(other));
    }

    default <A> Interpreter overrideWith(BiFunction<InterpreterContext, Generator<A>, CompiledGenerator<A>> other) {
    ...
    static <A> Interpreter interpreter(BiFunction<InterpreterContext, Generator<A>, CompiledGenerator<A>> handler) {
